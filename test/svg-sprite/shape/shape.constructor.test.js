...
const { defaultConfig } = require('../../../lib/svg-sprite/shape.js');
...
describe('testing Shape.constructor', () => {
    describe('testing constructor', () => {
        ...
        describe('config', () => {
            ...
            it('should set default config if spriter.config is not passed', () => {
                expect.hasAssertions();
                ...
                expect(shape.config).toStrictEqual(defaultConfig);
            });
